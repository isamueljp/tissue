      ...
      <DialogContent className="sm:max-w-md bg-black border-border">
        <DialogHeader>
          ...
          <p className="text-center text-gray-400 text-sm mt-2">
            {isSignUp ? 'Join fourth degree today' : 'Welcome back to fourth degree'}
          </p>
        </DialogHeader>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <Button
            type="submit"
            disabled={loading}
            className="w-full bg-gradient-to-r from-[#00197e] to-blue-600 hover:from-blue-700 hover:to-[#00197e] disabled:opacity-50"
          >
